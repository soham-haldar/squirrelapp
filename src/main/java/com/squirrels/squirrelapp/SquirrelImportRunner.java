...
@Service
public class SquirrelImportRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (repository.count() == 0) {
            importCSV(getCSVFile());
        }
    }

    private File getCSVFile() throws IOException {
        // Load from Resources folder
        ClassPathResource resource = new ClassPathResource("cleaned_squirrel_data.csv");
